...
{
	public async Task<DiagnosticsDeltaInfo> GetDeltaAsync(Solution beforeSolution, Solution afterSolution, DocumentId documentId, CancellationToken cancellationToken)
	{
