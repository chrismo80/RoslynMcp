...
internal static class Extensions
{
	...
	internal static async Task<IReadOnlyList<ISymbol>> FindImplementationSymbolsAsync(this ISymbol symbol, Solution solution, CancellationToken cancellationToken)
	{
	...
	private static CompactSymbol? WithOptionalWorkspaceRelativePathValues(this CompactSymbol? symbol)
		=> symbol is null ? null : symbol.WithWorkspaceRelativePathValues();
	...
	private static ISymbol NormalizeSearchRoot(ISymbol symbol)
	{
		...
		if (symbol is IPropertySymbol property)
		{
			...
			if (property.IsOverride && property.OverriddenProperty is not null)
