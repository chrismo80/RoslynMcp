...
namespace RoslynMcp.Tools.Inspection.RunTests.Internals;

internal sealed partial class ResultInterpreter
{
    public static Result Interpret(ProcessResult processResult, IReadOnlyList<string> trxReportPaths)
    {
        ...
        return new Result(Outcomes.BuildFailed, processResult.ExitCode, [],
